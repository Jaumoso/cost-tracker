...
//           })
//         };
//         return this.http.post<Operation>(baseURL + 'operation/new/' + operation._id, operation, httpOptions)
//         .pipe(catchError(this.processHTTPMsgService.handleError));
//     }
...
//           })
//         };
//         return this.http.put<Operation>(baseURL + 'operation/edit/' + operation._id, operation, httpOptions)
//         .pipe(catchError(this.processHTTPMsgService.handleError));
//     }
